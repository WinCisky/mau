...
{#if isLogged}
    <div class="flex flex-col w-full justify-center items-center">
        <div class="flex flex-col w-full gap-6 max-w-xl justify-center items-center">
            <div
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div>
                            ...
                            <select bind:value={$selectedTheme} id="theme-select" class="select w-full max-w-xs">
...
{:else}
    <div class="flex flex-col w-full">
        <div
            ...
            style="background-image: url({chillImg});"
        >
            <div class="hero-overlay bg-opacity-60 rounded-xl"></div>
            <div class="hero-content text-center text-neutral-content">
                <div class="max-w-md">
                    <h1 class="mb-5 text-5xl font-bold">Hello there</h1>
                    <p class="mb-5">get cozy and join the fireplace</p>
                    <button class="btn" on:click={() => providerLogin({name:'google'})}>
                        Login with Google
                        <svg
                            version="1.1"
                    ...
                    <button class="btn" on:click={() => providerLogin({name:'github'})}>
                        Login with GitHub
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
